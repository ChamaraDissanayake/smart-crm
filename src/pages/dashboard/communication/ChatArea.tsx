...
import { AttachmentHandler, AttachmentHandlerRef, PendingAttachment } from './AttachmentHandler';
...
interface ChatAreaProps {
    ...
    attachmentHandlerRef?: React.Ref<{ handleRemove: (fileName: string) => void }>;
    onRemoveAttachment?: (filename: string) => void;
    ref?: React.Ref<{ handleRemove: (fileName: string) => void }>;
}

export const ChatArea = forwardRef<{ handleRemove: (fileName: string) => void }, ChatAreaProps>(
    ({
        selectedChannel,
        unreadCounts,
        onChannelChange,
        ...
        const attachmentHandlerRef = useRef<AttachmentHandlerRef>(null);
